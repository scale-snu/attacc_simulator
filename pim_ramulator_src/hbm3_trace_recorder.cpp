...
class HBM3TraceRecorder : public IControllerPlugin, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IControllerPlugin, HBM3TraceRecorder, "HBM3TraceRecorder", "CounterBasedTRR.")
  private:
    IDRAM* m_dram;
